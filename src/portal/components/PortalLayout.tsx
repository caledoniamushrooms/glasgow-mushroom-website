...
const adminNavItems = [
  ...
  { to: '/portal/admin/assets', label: 'Asset Register', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
  { to: '/portal/admin/activity', label: 'Activity', icon: 'M3 3v18h18M18.7 8l-5.1 5.2-2.8-2.7L7 14.3' },
]
